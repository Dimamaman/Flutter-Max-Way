...
import '../widgets/branch_shimmer_order.dart';
...
class _OrderTakeAwayTabState extends State<OrderTakeAwayTab> {
  ...
  Future<void> moveToBranch(Point point) async {
    var controller = await mapController.future;
    await Geolocator.getCurrentPosition(desiredAccuracy: LocationAccuracy.bestForNavigation).then((Position position) {
      controller.moveCamera(animation: const MapAnimation(type: MapAnimationType.linear, duration: 1), CameraUpdate.newCameraPosition(CameraPosition(target: point, zoom: 18)));
    }).catchError((e) {
      //
    });
    getCameraPos();
  ...
  Widget build(BuildContext context) {
    locationName = _locationModel.regionName.isEmpty ? '' : '${_locationModel.cityName},${_locationModel.street}';
                        ...
                        SizedBox(
                          ...
                          child: Stack(
                            children: [
                              ...
                              Center(
                                child: Padding(padding: const EdgeInsets.only(bottom: 30), child: SvgPicture.asset('assets/images/pin.svg',
                                    height: 50)),
                              ),
                              Positioned(
                                bottom: 8,
                        ...
                        Builder(builder: (context) {
                          ...
                          try {
                              ...
                              children: [
                                InkWell(
                                  onTap: () {
                                    ...
                                    context.read<OrderDetailProvider>().updateBranchName(list[0].name);
                                  },
                                  child: SizedBox(
                                ...
                                InkWell(
                                  onTap: () {
                                    ...
                                    context.read<OrderDetailProvider>().updateBranchName(list[1].name);
                                  },
                                  child: SizedBox(
                                    height: MediaQuery.of(context).size.height * 0.08,
                                    child: Row(
                                ...
                                InkWell(
                                  onTap: () {
                                    ...
                                    context.read<OrderDetailProvider>().updateBranchName(list[2].name);
                                  },
                                  child: SizedBox(
                                    height: MediaQuery.of(context).size.height * 0.08,
                                    child: Row(
                                ...
                                InkWell(
                                  onTap: () {
                                    ...
                                    context.read<OrderDetailProvider>().updateBranchName(list[3].name);
                                  },
                                  child: SizedBox(
                                    height: MediaQuery.of(context).size.height * 0.08,
                                    child: Row(
                                ...
                                InkWell(
                                  onTap: () {
                                    ...
                                    context.read<OrderDetailProvider>().updateBranchName(list[4].name);
                                  },
                                  child: SizedBox(
                                    height: MediaQuery.of(context).size.height * 0.08,
                                    child: Row(
                                ...
                                InkWell(
                                  onTap: () {
                                    ...
                                    context.read<OrderDetailProvider>().updateBranchName(list[5].name);
                                  },
                                  child: SizedBox(
                                    height: MediaQuery.of(context).size.height * 0.08,
                                    child: Row(
                                ...
                                InkWell(
                                  onTap: () {
                                    ...
                                    context.read<OrderDetailProvider>().updateBranchName(list[6].name);
                                  },
                                  child: SizedBox(
                                    height: MediaQuery.of(context).size.height * 0.08,
                                    child: Row(
                                ...
                                InkWell(
                                  onTap: () {
                                    ...
                                    context.read<OrderDetailProvider>().updateBranchName(list[7].name);
                                  },
                                  child: SizedBox(
                                    height: MediaQuery.of(context).size.height * 0.08,
                                    child: Row(
                                ...
                                InkWell(
                                  onTap: () {
                                    ...
                                    context.read<OrderDetailProvider>().updateBranchName(list[8].name);
                                  },
                                  child: SizedBox(
                                    height: MediaQuery.of(context).size.height * 0.08,
                                    child: Row(
                                ...
                                InkWell(
                                  onTap: () {
                                    ...
                                    context.read<OrderDetailProvider>().updateBranchName(list[9].name);
                                  },
                                  child: SizedBox(
                                    height: MediaQuery.of(context).size.height * 0.08,
                                    child: Row(
                                ...
                                InkWell(
                                  onTap: () {
                                    ...
                                    context.read<OrderDetailProvider>().updateBranchName(list[10].name);
                                  },
                                  child: SizedBox(
                                    height: MediaQuery.of(context).size.height * 0.08,
                                    child: Row(
                                ...
                                InkWell(
                                  onTap: () {
                                    ...
                                    context.read<OrderDetailProvider>().updateBranchName(list[11].name);
                                  },
                                  child: SizedBox(
                                    height: MediaQuery.of(context).size.height * 0.08,
                                    child: Row(
                                ...
                                InkWell(
                                  onTap: () {
                                    ...
                                    context.read<OrderDetailProvider>().updateBranchName(list[12].name);
                                  },
                                  child: SizedBox(
                                    height: MediaQuery.of(context).size.height * 0.08,
                                    child: Row(
                                ...
                                InkWell(
                                  onTap: () {
                                    ...
                                    context.read<OrderDetailProvider>().updateBranchName(list[13].name);
                                  },
                                  child: SizedBox(
                                    height: MediaQuery.of(context).size.height * 0.08,
                                    child: Row(
                                ...
                                InkWell(
                                  onTap: () {
                                    ...
                                    context.read<OrderDetailProvider>().updateBranchName(list[14].name);
                                  },
                                  child: SizedBox(
                                    height: MediaQuery.of(context).size.height * 0.08,
                                    child: Row(
                                ...
                                InkWell(
                                  onTap: () {
                                    ...
                                    context.read<OrderDetailProvider>().updateBranchName(list[15].name);
                                  },
                                  child: SizedBox(
                                    height: MediaQuery.of(context).size.height * 0.08,
                                    child: Row(
                                ...
                                InkWell(
                                  onTap: () {
                                    ...
                                    context.read<OrderDetailProvider>().updateBranchName(list[16].name);
                                  },
                                  child: SizedBox(
                                    height: MediaQuery.of(context).size.height * 0.08,
                                    child: Row(
                            ...
                            return Center(
                              child: Column(
                                mainAxisAlignment: MainAxisAlignment.center,
                                children: [const Icon(Icons.error, color: Colors.red, size: 40), Text('$e')],
                              ),
                            );
                          }
                        }),
